...
<body class="bg-gray-100 min-h-screen">
  ...
  <div class="flex max-w-7xl mx-auto mt-8 px-4">
    ...
    // Hitung total musik
    $jumlah_musik = mysqli_num_rows(mysqli_query($db, "SELECT id_musik FROM tbl_musik"));
    ?>
    <!-- Main Content -->
    <main class="w-3/4 bg-white rounded shadow p-6 ml-6">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mt-6">
        ...
        <div class="bg-white shadow rounded p-4 text-center border-t-4 border-green-600">
         ...
         <div class="bg-white shadow rounded p-4 text-center border-t-4 border-blue-600">
          <h3 class="text-xl font-semibold text-blue-700">Musik</h3>
          <p class="text-3xl font-bold text-gray-800"><?php echo $jumlah_musik; ?></p>
        </div>
      </div>
    </main>
  </div>
  ...
  <footer class="bg-blue-800 text-white text-center py-4 mt-10">
    &copy; <?php echo date('Y'); ?> | Created by Yudha adi nugraha
  </footer>
